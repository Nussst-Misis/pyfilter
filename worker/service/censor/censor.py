...
def extract_wav(video: str, out: str):
    command = "yes|ffmpeg -i {} -ab 160k -ac 2 -ar 44100 -vn {}".format(video, out)
    subprocess.call(command, shell=True)


def merge(video: str, audio: str, out: str):
    command = "yes|ffmpeg -i {} -i {} -vcodec copy {}".format(video, audio, out)
    subprocess.call(command, shell=True)
...
if __name__ == "__main__":
    ...
    censor(source_video, source_audio, result_video, [seg1, seg2, seg3], [tf1, tf2])
